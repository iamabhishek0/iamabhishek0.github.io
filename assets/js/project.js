...
const exp = [
  {
    ...
    desp: "<li><a href='https://github.com/kiwitcms/Kiwi'>Kiwi TCMS</a> is the leading open source test case management system.</li> " +
  ...
  },
  {
    ...
    desp: "<li><a href='https://github.com/poliastro/poliastro'>poliastro</a> is an open source pure Python package dedicated to problems arising in Astrodynamics and Orbital Mechanics</li>" +
  ...
  },
  {
    ...
    desp: "<li><a href='https://github.com/sympy/sympy'>Sympy</a> is a Python library for symbolic mathematics.</li>" +
...
const mentor = [
  {
    ...
    desp: "<li>poliastro-live is an online Python Shell that uses poliastro in the backend.</li>" +
  ...
  },
  {
    ...
    desp: "<li>Poliastro-API is a Flask wrapper around poliastro that lets you call poliastro function using REST API calls.</li>" +
  ...
  },
  {
    ...
    desp: "<li>Sudoku Solver is a 9x9 Standard Sudoku Game which is made using Django</li> " +
  ...
  },
  {
    ...
    desp: "<li>This project is a sign language alphabet recognizer using Python, openCV and Tensorflow.</li> " +
  ...
  },
  {
    ...
    desp: "<li>Mask Detection Web API detects masks in video streams in real time.</li> " +
